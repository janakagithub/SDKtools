SERVICE = compare_models_multiple
SERVICE_CAPS = compare_models_multiple
SPEC_FILE = compare_models_multiple.spec
URL = https://kbase.us/services/compare_models_multiple
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
