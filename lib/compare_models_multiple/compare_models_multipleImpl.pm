package compare_models_multiple::compare_models_multipleImpl;
use strict;
...
sub new
{
    ...
    my $wsInstance = $cfg->val('compare_models_multiple','workspace-url');
...
sub count_contigs
{
    ...
    my $ctx = $compare_models_multiple::compare_models_multipleServer::CallContext;
    my($return);
    #BEGIN count_contigs
